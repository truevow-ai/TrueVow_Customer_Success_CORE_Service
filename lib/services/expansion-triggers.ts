...
export class ExpansionTriggersService {
  ...
  static async evaluateTriggers(
    ...
    for (const trigger of triggers) {
      ...
      if (conditionMet.met) {
        // Execute trigger
        await this.executeTrigger(trigger, tenantId, customerEmail, conditionMet.metricValue, conditionMet.metricType)
      }
    }
  }
  ...
  private static async executeNotificationAction(
    ...
    // TODO: Get CSM for tenant
    // For now, create a ticket/notification
