"""
Script to convert CS-Support Service Implementation Plan from Markdown to Word (.docx) format.
"""
...
MD_FILE = os.path.join(CS_SUPPORT_DIR, "docs", "CS_SUPPORT_SERVICE_IMPLEMENTATION_PLAN.md")
DOCX_FILE = os.path.join(CS_SUPPORT_DIR, "CS_SUPPORT_SERVICE_IMPLEMENTATION_PLAN.docx")
# Try to use temp file if original is locked
TEMP_DOCX_FILE = os.path.join(CS_SUPPORT_DIR, "CS_SUPPORT_SERVICE_IMPLEMENTATION_PLAN-UPDATED.docx")
...
def convert_markdown_to_docx(md_path, docx_path):
    ...
    try:
        ...
        try:
            ...
            print(f"  1. Delete or rename the old CS_SUPPORT_SERVICE_IMPLEMENTATION_PLAN.docx")
            print(f"  2. Rename CS_SUPPORT_SERVICE_IMPLEMENTATION_PLAN-UPDATED.docx to CS_SUPPORT_SERVICE_IMPLEMENTATION_PLAN.docx")
            return True
...
def main():
    print("=" * 80)
    print("Converting CS-Support Service Implementation Plan to Word Document")
    print("=" * 80)
    print()
